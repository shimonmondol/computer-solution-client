            ...
            <div>
                <div>
                    <div className='mx-48'>
                        ...
                        <h2 className='text-2xl font-bold me-6 mt-3 mb-6'>10000+ Customers</h2>
                    </div>
                ...
                <div>
                    <div className='mx-48'>
                        ...
                        <h2 className='text-2xl font-bold mt-3 mb-6'>100M+ Annual Revenue</h2>
                    </div>
                </div>
                ...
                <div>
                    <div className='mx-48'>
                        ...
                        <h2 className='text-2xl font-bold mt-3 mb-6'>50K+ Reviews</h2>
                    </div>
                </div>
                ...
                <div>
                    <div className='mx-48'>
                        ...
                        <h2 className='text-2xl font-bold mt-3 mb-6'>100+ Parts</h2>
                    </div>
                </div>
